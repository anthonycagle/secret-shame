...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_13384 = (0);while(true){
if((i_13384 < arr.length))
{(arr[i_13384] = null);
{
...
{var i_13391 = (self__.level + (1));while(true){
if((i_13391 <= (new_level + (1))))
{(update[i_13391] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_13393 = (0);while(true){
if((i_13393 <= self__.level))
{var links_13394 = (update[i_13393]).forward;if(((links_13394[i_13393]) === x__$1))
{(links_13394[i_13393] = (x__$1.forward[i_13393]));
{
var G__13395 = (i_13393 + (1));
i_13393 = G__13395;
continue;
}
} else
{{
var G__13396 = (i_13393 + (1));
i_13393 = G__13396;
continue;
}
}
