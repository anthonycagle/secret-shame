...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_13372 = (0);while(true){
if((i_13372 < arr.length))
{(arr[i_13372] = null);
{
...
{var i_13379 = (self__.level + (1));while(true){
if((i_13379 <= (new_level + (1))))
{(update[i_13379] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_13381 = (0);while(true){
if((i_13381 <= self__.level))
{var links_13382 = (update[i_13381]).forward;if(((links_13382[i_13381]) === x__$1))
{(links_13382[i_13381] = (x__$1.forward[i_13381]));
{
