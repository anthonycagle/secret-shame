...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t13483 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t13483 = (function (val,box,meta13484){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t13483.cljs$lang$type = true;
cljs.core.async.impl.channels.t13483.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t13483";
cljs.core.async.impl.channels.t13483.cljs$lang$ctorPrWriter = (function (this__4127__auto__,writer__4128__auto__,opt__4129__auto__){return cljs.core._write.call(null,writer__4128__auto__,"cljs.core.async.impl.channels/t13483");
});
cljs.core.async.impl.channels.t13483.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t13483.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_13485){var self__ = this;
var _13485__$1 = this;return self__.meta13484;
});
cljs.core.async.impl.channels.t13483.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_13485,meta13484__$1){var self__ = this;
var _13485__$1 = this;return (new cljs.core.async.impl.channels.t13483(self__.val,self__.box,meta13484__$1));
});
cljs.core.async.impl.channels.__GT_t13483 = (function __GT_t13483(val__$1,box__$1,meta13484){return (new cljs.core.async.impl.channels.t13483(val__$1,box__$1,meta13484));
});
}
return (new cljs.core.async.impl.channels.t13483(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_13486 = self__.takes.pop();if((taker_13486 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_13486))
{var take_cb_13487 = cljs.core.async.impl.protocols.commit.call(null,taker_13486);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_13487,taker_13486,this$__$1){
return (function (){return take_cb_13487.call(null,null);
});})(take_cb_13487,taker_13486,this$__$1))
);
} else
{}
{
...
var putter_13488 = self__.puts.pop();if(!((putter_13488 == null)))
{var put_handler_13489 = putter_13488.handler;var val_13490 = putter_13488.val;if(cljs.core.async.impl.protocols.active_QMARK_.call(null,put_handler_13489))
{var put_cb_13491 = cljs.core.async.impl.protocols.commit.call(null,put_handler_13489);var __13492__$1 = cljs.core.async.impl.protocols.commit.call(null,handler);cljs.core.async.impl.dispatch.run.call(null,((function (put_cb_13491,__13492__$1,put_handler_13489,val_13490,putter_13488,_,retval,this$__$1){
return (function (){return put_cb_13491.call(null,true);
});})(put_cb_13491,__13492__$1,put_handler_13489,val_13490,putter_13488,_,retval,this$__$1))
);
cljs.core.async.impl.protocols.add_BANG_.call(null,self__.buf,val_13490);
} else
{{
continue;
}
