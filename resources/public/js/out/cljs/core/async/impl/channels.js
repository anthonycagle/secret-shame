...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t13471 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t13471 = (function (val,box,meta13472){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t13471.cljs$lang$type = true;
cljs.core.async.impl.channels.t13471.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t13471";
cljs.core.async.impl.channels.t13471.cljs$lang$ctorPrWriter = (function (this__4127__auto__,writer__4128__auto__,opt__4129__auto__){return cljs.core._write.call(null,writer__4128__auto__,"cljs.core.async.impl.channels/t13471");
});
cljs.core.async.impl.channels.t13471.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t13471.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_13473){var self__ = this;
var _13473__$1 = this;return self__.meta13472;
});
cljs.core.async.impl.channels.t13471.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_13473,meta13472__$1){var self__ = this;
var _13473__$1 = this;return (new cljs.core.async.impl.channels.t13471(self__.val,self__.box,meta13472__$1));
});
cljs.core.async.impl.channels.__GT_t13471 = (function __GT_t13471(val__$1,box__$1,meta13472){return (new cljs.core.async.impl.channels.t13471(val__$1,box__$1,meta13472));
});
}
return (new cljs.core.async.impl.channels.t13471(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_13474 = self__.takes.pop();if((taker_13474 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_13474))
{var take_cb_13475 = cljs.core.async.impl.protocols.commit.call(null,taker_13474);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_13475,taker_13474,this$__$1){
return (function (){return take_cb_13475.call(null,null);
});})(take_cb_13475,taker_13474,this$__$1))
);
} else
{}
{
...
var putter_13476 = self__.puts.pop();if(!((putter_13476 == null)))
{var put_handler_13477 = putter_13476.handler;var val_13478 = putter_13476.val;if(cljs.core.async.impl.protocols.active_QMARK_.call(null,put_handler_13477))
{var put_cb_13479 = cljs.core.async.impl.protocols.commit.call(null,put_handler_13477);var __13480__$1 = cljs.core.async.impl.protocols.commit.call(null,handler);cljs.core.async.impl.dispatch.run.call(null,((function (put_cb_13479,__13480__$1,put_handler_13477,val_13478,putter_13476,_,retval,this$__$1){
return (function (){return put_cb_13479.call(null,true);
});})(put_cb_13479,__13480__$1,put_handler_13477,val_13478,putter_13476,_,retval,this$__$1))
);
cljs.core.async.impl.protocols.add_BANG_.call(null,self__.buf,val_13478);
} else
{{
continue;
}
