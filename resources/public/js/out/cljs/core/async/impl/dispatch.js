...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_13477 = (0);while(true){
var m_13478 = cljs.core.async.impl.dispatch.tasks.pop();if((m_13478 == null))
{} else
{m_13478.call(null);
if((count_13477 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__13479 = (count_13477 + (1));
count_13477 = G__13479;
continue;
}
} else
{}
