...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_13465 = (0);while(true){
var m_13466 = cljs.core.async.impl.dispatch.tasks.pop();if((m_13466 == null))
{} else
{m_13466.call(null);
if((count_13465 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__13467 = (count_13465 + (1));
count_13465 = G__13467;
continue;
}
} else
{}
