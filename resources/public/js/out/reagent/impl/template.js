...
{return (function() { 
var G__9136__delegate = function (args){return cljs.core.apply.call(null,v,args);
};
...
reagent.impl.template.undash_prop_name = (function undash_prop_name(n){var or__3560__auto__ = reagent.impl.template.attr_aliases.call(null,n);if(cljs.core.truth_(or__3560__auto__))
...
{return cljs.core.reduce_kv.call(null,(function (res,k,v){var G__9139 = res;(G__9139[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.to_js_val.call(null,v));
return G__9139;
}),{},val);
} else
...
reagent.impl.template.set_id_class = (function set_id_class(props,p__9140){var vec__9142 = p__9140;var id = cljs.core.nth.call(null,vec__9142,(0),null);var class$ = cljs.core.nth.call(null,vec__9142,(1),null);var pid = (props["id"]);(props["id"] = ((!((pid == null)))?pid:id));
if((class$ == null))
{return null;
} else
...
{if(new cljs.core.Keyword(null,"else","else",-1508377146))
{var objprops = cljs.core.reduce_kv.call(null,(function (o,k,v){var pname_9143 = reagent.impl.template.cached_prop_name.call(null,k);if(!((pname_9143 === "key")))
{(o[pname_9143] = reagent.impl.template.convert_prop_value.call(null,v));
} else
{}
return o;
...
var G__9146 = jsprops;(G__9146["defaultValue"] = value);
(G__9146["value"] = null);
(G__9146["onChange"] = ((function (G__9146,on_change,value){
return (function (p1__9144_SHARP_){return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__9144_SHARP_);
});})(G__9146,on_change,value))
);
return G__9146;
}
});
...
reagent.impl.template.add_input_methods = (function add_input_methods(spec){var G__9148 = spec;(G__9148["componentDidUpdate"] = ((function (G__9148){
return (function (){var C = this;return reagent.impl.template.input_did_update.call(null,C);
});})(G__9148))
);
(G__9148["componentWillUnmount"] = ((function (G__9148){
...
return (function (p1__9149_SHARP_,p2__9150_SHARP_){var C = this;return reagent.impl.template.wrapped_should_update.call(null,C,p1__9149_SHARP_,p2__9150_SHARP_);
...
reagent.impl.template.parse_tag = (function parse_tag(hiccup_tag){var vec__9152 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));var tag = cljs.core.nth.call(null,vec__9152,(0),null);var id = cljs.core.nth.call(null,vec__9152,(1),null);var class$ = cljs.core.nth.call(null,vec__9152,(2),null);var comp = (reagent.impl.template.DOM[tag]);var class_SINGLEQUOTE_ = (cljs.core.truth_(class$)?clojure.string.replace.call(null,class$,/\./," "):null);if(cljs.core.truth_(comp))
{} else
...
reagent.impl.template.get_wrapper = (function get_wrapper(tag){var vec__9154 = reagent.impl.template.parse_tag.call(null,tag);var comp = cljs.core.nth.call(null,vec__9154,(0),null);var id_class = cljs.core.nth.call(null,vec__9154,(1),null);return reagent.impl.template.wrap_component.call(null,comp,id_class,(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(tag)));
});
...
var c = reagent.impl.template.as_class.call(null,cljs.core.nth.call(null,v,(0)));var jsprops = (function (){var obj9158 = {};(obj9158[reagent.impl.util.cljs_argv] = v);
(obj9158[reagent.impl.util.cljs_level] = level);
return obj9158;
})();var k_9159 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,v));var k_SINGLEQUOTE__9160 = (((k_9159 == null))?reagent.impl.template.get_key.call(null,cljs.core.nth.call(null,v,(1),null)):k_9159);if((k_SINGLEQUOTE__9160 == null))
{} else
{(jsprops["key"] = k_SINGLEQUOTE__9160);
}
...
reagent.impl.template.expand_seq = (function expand_seq(s,level){var a = cljs.core.into_array.call(null,s);var level_SINGLEQUOTE_ = (level + (1));var n__4416__auto___9161 = a.length;var i_9162 = (0);while(true){
if((i_9162 < n__4416__auto___9161))
{(a[i_9162] = reagent.impl.template.as_component.call(null,(a[i_9162]),level_SINGLEQUOTE_));
{
...
reagent.impl.template.convert_args = (function convert_args(argv,first_child,level){var a = cljs.core.into_array.call(null,argv);var n__4416__auto___9164 = a.length;var i_9165 = (0);while(true){
if((i_9165 < n__4416__auto___9164))
{if((i_9165 >= first_child))
{(a[i_9165] = reagent.impl.template.as_component.call(null,(a[i_9165]),level));
} else
{}
{
