...
{var C_9119 = (a[i]);if(cljs.core.truth_(C_9119.cljsIsDirty))
{C_9119.forceUpdate();
} else
{}
{
...
reagent.impl.batching.dispose = (function dispose(C){var ratom_9121 = C.cljsRatom;if(!((ratom_9121 == null)))
{reagent.ratom.dispose_BANG_.call(null,ratom_9121);
} else
{}
