...
reagent.impl.batching.next_tick = ((cljs.core.not.call(null,reagent.impl.util.is_client))?reagent.impl.batching.fake_raf:(function (){var w = window;var or__3560__auto__ = w.requestAnimationFrame;if(cljs.core.truth_(or__3560__auto__))
...
{var C_9131 = (a[i]);if(cljs.core.truth_(C_9131.cljsIsDirty))
{C_9131.forceUpdate();
} else
{}
{
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__4127__auto__,writer__4128__auto__,opt__4129__auto__){return cljs.core._write.call(null,writer__4128__auto__,"reagent.impl.batching/RenderQueue");
});
...
reagent.impl.batching.dispose = (function dispose(C){var ratom_9133 = C.cljsRatom;if(!((ratom_9133 == null)))
{reagent.ratom.dispose_BANG_.call(null,ratom_9133);
} else
{}
