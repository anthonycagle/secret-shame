...
var G__9112__delegate = function (x,rest){return cljs.core.apply.call(null,reagent.ratom.atom,x,rest);
};
var G__9112 = function (x,var_args){
var rest = null;if (arguments.length > 1) {
  rest = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return G__9112__delegate.call(this,x,rest);};
G__9112.cljs$lang$maxFixedArity = 1;
G__9112.cljs$lang$applyTo = (function (arglist__9113){
var x = cljs.core.first(arglist__9113);
var rest = cljs.core.rest(arglist__9113);
return G__9112__delegate(x,rest);
});
...
partial.cljs$lang$applyTo = (function (arglist__9114){
