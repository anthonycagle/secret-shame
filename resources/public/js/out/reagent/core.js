...
var G__9100__delegate = function (x,rest){return cljs.core.apply.call(null,reagent.ratom.atom,x,rest);
};
var G__9100 = function (x,var_args){
var rest = null;if (arguments.length > 1) {
  rest = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return G__9100__delegate.call(this,x,rest);};
G__9100.cljs$lang$maxFixedArity = 1;
G__9100.cljs$lang$applyTo = (function (arglist__9101){
var x = cljs.core.first(arglist__9101);
var rest = cljs.core.rest(arglist__9101);
return G__9100__delegate(x,rest);
});
...
partial.cljs$lang$applyTo = (function (arglist__9102){
