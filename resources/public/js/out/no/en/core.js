...
var url_encode__delegate = function (s,p__10684){var vec__10686 = p__10684;var encoding = cljs.core.nth.call(null,vec__10686,(0),null);if(cljs.core.truth_(s))
...
var p__10684 = null;if (arguments.length > 1) {
  p__10684 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return url_encode__delegate.call(this,s,p__10684);};
url_encode.cljs$lang$maxFixedArity = 1;
url_encode.cljs$lang$applyTo = (function (arglist__10687){
var s = cljs.core.first(arglist__10687);
var p__10684 = cljs.core.rest(arglist__10687);
return url_encode__delegate(s,p__10684);
});
...
var url_decode__delegate = function (s,p__10688){var vec__10690 = p__10688;var encoding = cljs.core.nth.call(null,vec__10690,(0),null);if(cljs.core.truth_(s))
...
return url_decode__delegate.call(this,s,p__10688);};
url_decode.cljs$lang$maxFixedArity = 1;
url_decode.cljs$lang$applyTo = (function (arglist__10691){
var s = cljs.core.first(arglist__10691);
var p__10688 = cljs.core.rest(arglist__10691);
return url_decode__delegate(s,p__10688);
});
...
{var G__10694 = clojure.string.upper_case.call(null,unit);switch (G__10694) {
default:
var G__10695 = unit;switch (G__10695) {
case "M":
...
*/
no.en.core.parse_integer = (function parse_integer(s){return no.en.core.parse_number.call(null,s,(function (p1__10698_SHARP_){return parseInt(p1__10698_SHARP_);
}));
});
/**
* Parse `s` as a long number.
*/
no.en.core.parse_long = (function parse_long(s){return no.en.core.parse_number.call(null,s,(function (p1__10699_SHARP_){return parseInt(p1__10699_SHARP_);
}));
});
/**
* Parse `s` as a double number.
*/
no.en.core.parse_double = (function parse_double(s){return no.en.core.parse_number.call(null,s,(function (p1__10700_SHARP_){return parseFloat(p1__10700_SHARP_);
}));
});
/**
* Parse `s` as a float number.
*/
no.en.core.parse_float = (function parse_float(s){return no.en.core.parse_number.call(null,s,(function (p1__10701_SHARP_){return parseFloat(p1__10701_SHARP_);
}));
});
/**
* Format the map `m` into a query parameter string.
*/
no.en.core.format_query_params = (function format_query_params(m){var params = clojure.string.join.call(null,"&",cljs.core.map.call(null,(function (p1__10704_SHARP_){return clojure.string.join.call(null,"=",p1__10704_SHARP_);
}),cljs.core.map.call(null,(function (p1__10703_SHARP_){return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[no.en.core.url_encode.call(null,cljs.core.name.call(null,cljs.core.first.call(null,p1__10703_SHARP_))),no.en.core.url_encode.call(null,cljs.core.second.call(null,p1__10703_SHARP_))],null));
}),cljs.core.remove.call(null,(function (p1__10702_SHARP_){return clojure.string.blank_QMARK_.call(null,(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.second.call(null,p1__10702_SHARP_))));
...
{return cljs.core.apply.call(null,cljs.core.hash_map,cljs.core.mapcat.call(null,(function (p1__10709_SHARP_){return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[cljs.core.keyword.call(null,no.en.core.url_decode.call(null,cljs.core.first.call(null,p1__10709_SHARP_))),no.en.core.url_decode.call(null,cljs.core.second.call(null,p1__10709_SHARP_))],null));
}),cljs.core.filter.call(null,(function (p1__10708_SHARP_){return cljs.core._EQ_.call(null,(2),cljs.core.count.call(null,p1__10708_SHARP_));
}),cljs.core.map.call(null,(function (p1__10707_SHARP_){return clojure.string.split.call(null,p1__10707_SHARP_,/=/);
...
}catch (e10711){if((e10711 instanceof Error))
{var e = e10711;if((n__$1 === (0)))
{throw e;
} else
{return null;
}
