...
var url_encode__delegate = function (s,p__10696){var vec__10698 = p__10696;var encoding = cljs.core.nth.call(null,vec__10698,(0),null);if(cljs.core.truth_(s))
...
var p__10696 = null;if (arguments.length > 1) {
  p__10696 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return url_encode__delegate.call(this,s,p__10696);};
url_encode.cljs$lang$maxFixedArity = 1;
url_encode.cljs$lang$applyTo = (function (arglist__10699){
var s = cljs.core.first(arglist__10699);
var p__10696 = cljs.core.rest(arglist__10699);
return url_encode__delegate(s,p__10696);
});
...
var url_decode__delegate = function (s,p__10700){var vec__10702 = p__10700;var encoding = cljs.core.nth.call(null,vec__10702,(0),null);if(cljs.core.truth_(s))
...
var p__10700 = null;if (arguments.length > 1) {
  p__10700 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return url_decode__delegate.call(this,s,p__10700);};
url_decode.cljs$lang$maxFixedArity = 1;
url_decode.cljs$lang$applyTo = (function (arglist__10703){
var s = cljs.core.first(arglist__10703);
var p__10700 = cljs.core.rest(arglist__10703);
return url_decode__delegate(s,p__10700);
});
...
{var G__10706 = clojure.string.upper_case.call(null,unit);switch (G__10706) {
default:
var G__10707 = unit;switch (G__10707) {
case "M":
...
*/
no.en.core.parse_integer = (function parse_integer(s){return no.en.core.parse_number.call(null,s,(function (p1__10710_SHARP_){return parseInt(p1__10710_SHARP_);
}));
});
/**
* Parse `s` as a long number.
*/
no.en.core.parse_long = (function parse_long(s){return no.en.core.parse_number.call(null,s,(function (p1__10711_SHARP_){return parseInt(p1__10711_SHARP_);
}));
});
/**
* Parse `s` as a double number.
*/
no.en.core.parse_double = (function parse_double(s){return no.en.core.parse_number.call(null,s,(function (p1__10712_SHARP_){return parseFloat(p1__10712_SHARP_);
}));
});
/**
* Parse `s` as a float number.
*/
no.en.core.parse_float = (function parse_float(s){return no.en.core.parse_number.call(null,s,(function (p1__10713_SHARP_){return parseFloat(p1__10713_SHARP_);
}));
});
/**
* Format the map `m` into a query parameter string.
*/
no.en.core.format_query_params = (function format_query_params(m){var params = clojure.string.join.call(null,"&",cljs.core.map.call(null,(function (p1__10716_SHARP_){return clojure.string.join.call(null,"=",p1__10716_SHARP_);
...
}),cljs.core.remove.call(null,(function (p1__10714_SHARP_){return clojure.string.blank_QMARK_.call(null,(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.second.call(null,p1__10714_SHARP_))));
